...
var BlogPublisherPlugin = class extends Plugin {
  ...
  async openSetting() {
    ...
    const directoryControls = /* @__PURE__ */ new Map();
    ...
    const refreshDirectorySummary = async () => {
      ...
      for (const [platform, control] of directoryControls) {
        ...
        control.button.textContent = isCurrent ? this.t("chooseBlogDirectory") : this.t("directoryChooseOnThisPlatform");
    ...
    for (const platform of ["windows", "macos"]) {
      ...
      label.textContent = this.t(platform === "windows" ? "platformWindows" : "platformMac") + (platform === currentPlatform ? this.t("platformCurrentSuffix") : "");
